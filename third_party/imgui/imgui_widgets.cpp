...
static bool InputTextFilterCharacter(unsigned int* p_char, ImGuiInputTextFlags flags, ImGuiInputTextCallback callback, void* user_data, ImGuiInputSource input_source)
{
    ...
    if (flags & (ImGuiInputTextFlags_CharsDecimal | ImGuiInputTextFlags_CharsHexadecimal | ImGuiInputTextFlags_CharsUppercase | ImGuiInputTextFlags_CharsNoBlank | ImGuiInputTextFlags_CharsScientific | ImGuiInputTextFlags_CharsNoSymbol))
    {
        ...
        // Allow 0-9 A-Z a-z
        if (flags & ImGuiInputTextFlags_CharsNoSymbol)
...
bool ImGui::InputTextEx(const char* label, const char* hint, char* buf, int buf_size, const ImVec2& size_arg, ImGuiInputTextFlags flags, ImGuiInputTextCallback callback, void* callback_user_data)
{
    ...
    IM_ASSERT(!((flags & ImGuiInputTextFlags_AlignToMiddle) && (flags & ImGuiInputTextFlags_Multiline)));          // Multiline won't work properly when align to middle.
